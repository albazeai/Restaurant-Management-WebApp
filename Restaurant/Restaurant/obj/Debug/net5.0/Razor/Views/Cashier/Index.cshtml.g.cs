#pragma checksum "C:\Users\Malba\OneDrive\Documents\RestaurantCapstone\Restaurant\Restaurant\Views\Cashier\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "eba3d3b61b9d0454e068427e643618d1a16a16d7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"eba3d3b61b9d0454e068427e643618d1a16a16d7", @"/Views/Cashier/Index.cshtml")]
...
#nullable disable
        ...
        <div class=""col-sm-5 col-md-5"">
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "eba3d3b61b9d0454e068427e643618d1a16a16d77848", async() => {
    ...
    ");
            ...
            function separate_pay_add_content(item) {
                ...
                for (let key in dict) {
                    let price = item_price(key);
            ");
                WriteLiteral(@"        total += price * dict[key];
            ...
            function separate_pay_remove_content(item) {
                ...
                displayTableItems(main_dict,false) // update the ");
                WriteLiteral(@"main table data 
                ...
                let sep_total = (total + Number(hst)).toFixed(2)
     ");
                WriteLiteral(@"           $(""#sep_total_seb"").text(total.toFixed(2))
                $(""#sep_hst"").text(hst)
                $(""#sep_total"").text(sep_total)
            ...
            $(""#sep_form"").submit(function () {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        // check if anything left on the t");
                WriteLiteral(@"able 
                        let flag = false;
                        for (let key in main_dict) {
                            if (main_dict[key] > 0) {
            ...
            $(""#clear_btn"").click(function () {
                if (confirm(""Ary you sure you want to clear this Table?"")) {
                    ...
                    if (tableId) {
             ");
                WriteLiteral(@"           /* sending request to clear the table */
                        $.ajax({
                            type: ""Post"",
