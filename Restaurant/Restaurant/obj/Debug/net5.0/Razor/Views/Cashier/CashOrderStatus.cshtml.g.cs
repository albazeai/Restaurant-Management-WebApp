#pragma checksum "C:\Users\Malba\OneDrive\Documents\RestaurantCapstone\Restaurant\Restaurant\Views\Cashier\CashOrderStatus.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c617f82c7acf5d0fd9a5b0bfeeab0263d005d24d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c617f82c7acf5d0fd9a5b0bfeeab0263d005d24d", @"/Views/Cashier/CashOrderStatus.cshtml")]
...
#nullable disable
            ...
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n");
#nullable restore
#line 12 "C:\Users\Malba\OneDrive\Documents\RestaurantCapstone\Restaurant\Restaurant\Views\Cashier\CashOrderStatus.cshtml"
            ...
            if (messages !== null) {
                ...
                WriteLiteral(@"++) {
                    ...
                    if (messages[i].status.toLowerCase() === ""not set"") {
                        $(""#main"").append('<div class=""alert alert-info""><h1 class=""bg-info text-center text-light p-2"">Table - ' + messages[i].tableId + '<span class=""badge badge-warning p-2 float-right"">Not-Set</span></h1><hr/><h2 class=""alert ");
                WriteLiteral(@"alert-danger text-dark p-2"">' + modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span>  ' + messages[i].notes + '</h3><hr/><button class=""btn btn-danger cancel"" value=""' + messages[i].messageId + '"">Cancel</button></div>');
                    }
                        ...
                        $(""#main"").append('<div class=""alert alert-success""><h1 class=""bg-info text-center t");
                WriteLiteral(@"ext-light p-2"">Table - ' + messages[i].tableId + '<span class=""badge badge-success p-2 float-right"">Ready</span></h1><hr/><h2 class=""text-dark"">' + modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span>  ' + messages[i].notes + '</h3><hr/><button class=""btn btn-success status-update"" value=""' + messages[i].messageId + '"">Picked Up</button></div>');
                    }
                }
