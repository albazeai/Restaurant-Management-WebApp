#pragma checksum "C:\Users\Malba\OneDrive\Documents\RestaurantCapstone\Restaurant\Restaurant\Views\Kitchen\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b7850edb49fba8c1aad060111a18dc8f5df3a914"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b7850edb49fba8c1aad060111a18dc8f5df3a914", @"/Views/Kitchen/Index.cshtml")]
            ...
            if (messages !== null) {
                ...
                WriteLiteral(@"et count = 0;
                    ...
                    if (messages[i].status.toLowerCase() === ""not set"") {
                        $(""#main"").append('<div class=""alert alert-info""><h1 class=""bg-info text-center text-light p-2"">Table - ' + messages[i].tableId + '<span class=""badge badge-warning p-2 float-right"">Not-Set</span></h1><hr/><h2 class=""alert alert-danger text-dark p-2"">' + ");
                WriteLiteral(@"modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span>  ' + messages[i].notes + '</h3><hr/><button class=""btn btn-danger s-update"" value=""' + messages[i].messageId + '"">in progress</button></div>');
                    }
                        ...
                        $(""#main"").append('<div class=""alert alert-success""><h1 class=""bg-info text-center text-");
                WriteLiteral(@"light p-2"">Table - ' + messages[i].tableId + '<span class=""badge badge-success p-2 float-right"">Ready</span></h1><hr/><h2 class=""text-dark"">' + modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span>  ' + messages[i].notes + '</h3><hr/><button class=""btn btn-success"" disabled>Order is Ready</button></div>');
                    }
                    // Calculating the quantity of each item
                    //let item = messages[i].items.split(',');
                    //let modItems = """";
                ...
                WriteLiteral(@"im())) {
                    ...
                    //if (messages[i].status.toLowerCase() === ""not set"") {
                    //    $(""#main"").append('<div class=""alert alert-info""><h1 class=""bg-info text-center text-light p-2"">Table - ' + messages[i].tableId + '</h1><hr/><h2 class=""alert alert-danger p-2"">' + modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span>  ' + messages[i].notes + '</h3><hr/><button class=""btn btn-danger s-update"" value=""' + messages[i].messageId + '"">in progress</button></div>');
                        
                    //}
                    //else if (messages[i].status.toLowerCase() === ""in progress"") {
                    //    $(""#main"").append('<div class=""alert alert-warning""><h1>Table - ' + messages[i].tableId + '</h1><hr/><h2>' + modItems + '</h2><hr/><h3><span class=""text-success""><em>Notes:</em></span> ");
                WriteLiteral(@" ' + messages[i].notes + '</h3><hr/><button class=""btn btn-success s-update"" value=""' + messages[i].messageId + '"">Complete</button></div>');
                    //}
                    //else if (messages[i].status.toLowerCase() === ""complete"") {
